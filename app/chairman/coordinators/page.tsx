...
export default async function ChairmanCoordinatorsPage() {
  ...
  return (
    <Shell roleLabel="Chairman" userName={user.name} navLinks={[{ href: "/chairman/coordinators", label: "Program Coordinators" }, { href: "/chairman/plos", label: "Program Learning Outcomes" }, { href: "/chairman/omc", label: "OMC Members" }]}>
