      ...
      <div style={{ background: "#fff", padding: "36px 40px", maxWidth: 560, width: "100%", border: "1px solid #E3E8F3" }}>
        {response.submittedAt ? (
          <>
            ...
            <p style={{ fontSize: 13.5, color: "#46507A" }}>Your response to "{response.surveyTemplate.title}" has already been recorded.</p>
          </>
        ) : (
          <>
            <h1 style={{ fontSize: 20, marginBottom: 4 }}>{response.surveyTemplate.title}</h1>
            <p style={{ fontSize: 13, color: "#46507A", marginBottom: 24 }}>
